...
export const SYNTHETIC_COGNIT_DEMO = Object.freeze({
  ...
  attendance: [
    ...
    { id: "demo-attendance-sofia-today", studentId: "demo-student-sofia-reyes", courseId: "demo-course-robotics-studio", sessionId: "demo-session-robotics-today", contextId: "demo-context-northfield-studio", sessionDate: "2026-08-31", status: "late", reportedBy: "Coach Priya Nair", reportedAt: "2026-08-31T18:02:00-04:00", classification: "confirmed_late", centerNote: "Arrival confirmed after the scheduled start.", eligibility: { ruleResult: "not_applicable", reason: "Late attendance does not create an absence entitlement." }, history: [{ at: "2026-08-31T18:02:00-04:00", action: "Late arrival confirmed", by: "Coach Priya Nair" }] },
    { id: "demo-attendance-mina-storytelling", studentId: "demo-student-mina-park", courseId: "demo-course-digital-storytelling-lab", sessionId: "demo-session-storytelling-today", contextId: "demo-context-northfield-studio", sessionDate: "2026-09-05", status: "reported_absence", reasonCategory: "illness", reportedBy: "Jin Park · authorized Family", reportedAt: "2026-09-04T18:12:00-04:00", classification: "reported_unconfirmed", centerNote: "Family reported illness before class. Center must confirm the classification.", eligibility: { ruleResult: "pending", reason: "Reported absence is not yet a confirmed absence." }, history: [{ at: "2026-09-04T18:12:00-04:00", action: "Absence reported", by: "Jin Park" }] },
    { id: "demo-attendance-sofia-prior", studentId: "demo-student-sofia-reyes", courseId: "demo-course-robotics-studio", sessionId: "demo-session-robotics-prior", contextId: "demo-context-northfield-studio", sessionDate: "2026-08-18", status: "confirmed_absent", reasonCategory: "appointment", reportedBy: "Daniel Reyes · authorized Family", reportedAt: "2026-08-17T14:20:00-04:00", classifiedBy: "Maya Chen", classifiedAt: "2026-08-18T09:10:00-04:00", classification: "recognized_absence", centerNote: "Appointment notice was received before the session.", eligibility: { ruleResult: "eligible", reason: "Confirmed appointment absence is recognized by Northfield policy.", entitlementId: "demo-makeup-sofia-robotics" }, history: [{ at: "2026-08-17T14:20:00-04:00", action: "Absence reported", by: "Daniel Reyes" }, { at: "2026-08-18T09:10:00-04:00", action: "Recognized absence confirmed", by: "Maya Chen" }] },
    { id: "demo-attendance-ava-prior", studentId: "demo-student-ava-thompson", courseId: "demo-course-digital-storytelling-lab", sessionId: "demo-session-storytelling-prior", contextId: "demo-context-northfield-studio", sessionDate: "2026-08-15", status: "confirmed_absent", reasonCategory: "other", reportedBy: "Center follow-up", reportedAt: "2026-08-16T10:30:00-04:00", classifiedBy: "Maya Chen", classifiedAt: "2026-08-16T11:00:00-04:00", classification: "unrecognized_absence", centerNote: "Reason did not meet the automatic policy rule.", eligibility: { ruleResult: "ineligible", reason: "Other/unrecognized reasons do not automatically create an entitlement.", override: null }, history: [{ at: "2026-08-16T11:00:00-04:00", action: "Absence confirmed; automatic eligibility denied", by: "Maya Chen" }] }
  ],
  makeupEntitlements: [
    { id: "demo-makeup-sofia-robotics", studentId: "demo-student-sofia-reyes", courseId: "demo-course-robotics-studio", contextId: "demo-context-northfield-studio", originType: "recognized_absence", originId: "demo-attendance-sofia-prior", issuanceReason: "Confirmed appointment absence", ruleResult: "eligible", issuedAt: "2026-08-18", expiresAt: "2026-10-02", status: "available", replacementSessionId: null, redeemedAt: null, label: "1 makeup available" },
    { id: "demo-makeup-sofia-robotics-redeemed", studentId: "demo-student-sofia-reyes", courseId: "demo-course-robotics-studio", contextId: "demo-context-northfield-studio", originType: "center_cancellation", originId: "demo-cancellation-robotics-weather", issuanceReason: "Center-cancelled instructional session", ruleResult: "eligible", issuedAt: "2026-07-20", expiresAt: "2026-09-03", status: "redeemed", replacementSessionId: "demo-session-robotics-recurring-tuesday", redeemedAt: "2026-09-01", label: "Redeemed makeup" },
    { id: "demo-makeup-sofia-robotics-expired", studentId: "demo-student-sofia-reyes", courseId: "demo-course-robotics-studio", contextId: "demo-context-northfield-studio", originType: "recognized_absence", originId: "demo-attendance-sofia-spring", issuanceReason: "Confirmed illness absence", ruleResult: "eligible", issuedAt: "2026-04-02", expiresAt: "2026-05-17", status: "expired", replacementSessionId: null, redeemedAt: null, label: "Expired makeup" }
  ],
