export const COGNIT_HQ_DEMO = Object.freeze({
  meta: {
    synthetic: true,
    label: "Cognit HQ synthetic network",
    steward: "Avery Chen",
    role: "Network Operations",
    authorizationPrinciple: "Hierarchy describes structure. Grants describe access."
  },
  centers: [
    { id: "riverton", name: "Riverton Learning Studio", city: "Riverton, CO", status: "Active", learners: 86, coaches: 7, version: "Demo 2.4", sync: "12 min ago", readiness: "Ready", adoption: 92 },
    { id: "oak-harbor", name: "Oak Harbor Lab", city: "Oak Harbor, WA", status: "Active", learners: 61, coaches: 5, version: "Demo 2.4", sync: "28 min ago", readiness: "Ready", adoption: 84 },
    ...
    { id: "sunfield", name: "Sunfield Learning Works", city: "Sunfield, AZ", status: "Active", learners: 48, coaches: 4, version: "Demo 2.3", sync: "2 hours ago", readiness: "Update ready", adoption: 76 },
    { id: "maple-crossing", name: "Maple Crossing Studio", city: "Maple Crossing, VT", status: "Active", learners: 35, coaches: 3, version: "Demo 2.4", sync: "1 hour ago", readiness: "Ready", adoption: 68 },
    { id: "bluewater", name: "Bluewater Learning Lab", city: "Bluewater, MI", status: "Inactive", learners: 14, coaches: 1, version: "Demo 2.2", sync: "5 days ago", readiness: "Needs decision", adoption: 41 }
  ],
  attention: [
    { type: "Curriculum", title: "Two Centers need template adoption review", detail: "Creative App Foundations Demo 2.4 is pending local review.", href: "/learninghub/demo/hq/curriculum" },
    { type: "Support", title: "One Center-impacting issue is escalated", detail: "A roster sync fixture needs a network operations owner.", href: "/learninghub/demo/hq/support" },
    ...
    { type: "Reporting", title: "Monthly network summary is ready", detail: "Synthetic aggregate trends are available for review.", href: "/learninghub/demo/hq/performance" },
  ...
  curriculum: [
    { name: "Creative App Foundations", category: "Digital making", status: "Published", version: "Demo 2.4", adoption: "5 of 6 Centers" },
  ...
  policies: [
    ...
    { name: "Student safety guideline", version: "Demo 2.1", status: "Active" },
  ...
  releases: [
    { name: "Family journey refinements", version: "Demo 2.5", stage: "In development", target: "Synthetic September window" },
    { name: "Coach aggregate insights", version: "Demo 2.6", stage: "Planning", target: "Synthetic October window" }
  ],
  modules: [
